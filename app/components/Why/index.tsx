...
const whydata: whydata[] = [
    {
        heading: "Instant and Verified Leads",
        subheading: "Get direct calls from interested candidates with verified profiles and contact details.",
    },
    {
        heading: "Candidates across India",
        subheading: "Access to over 70 Lakh+ active job seekers from every corner of India.",
    },
    {
        heading: "Advance Productivity Tools",
        subheading: "Powerful hiring tools to streamline your recruitment process and find the right talent faster.",
    }
]
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2'>
                    ...
                    >
                        ...
                        <motion.h4 
                            ...
                            transition={{ duration: 0.6, delay: 0.6 }}
                        >
                            Over 70 Lakh Active Job Seekers. Leverage the expertise of our platform to power your hiring with verified candidates, advanced tools, and nationwide reach.
                        </motion.h4>

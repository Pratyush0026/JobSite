...
const Aboutdata: datatype[] = [
  {
    ...
    country: "Bengaluru",
    paragraph:
      "Tech hub with 15,000+ job openings in IT, startups, and multinational companies.",
  },
  {
    imgSrc: "/assets/network/america.svg",
    country: "Chennai",
    paragraph:
      "Manufacturing and automotive center with opportunities in engineering and services.",
  },
  {
    imgSrc: "/assets/network/australia.svg",
    country: "Pune",
    paragraph:
      "Growing IT and education hub offering diverse career opportunities for professionals.",
  },
  {
    imgSrc: "/assets/network/china.svg",
    country: "Mumbai",
    paragraph:
      "Financial capital with opportunities in finance, entertainment, and business services.",
  },
];

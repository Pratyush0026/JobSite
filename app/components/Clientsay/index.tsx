    ...
    >
      <div className="bg-image-what">
        ...
        >
          ...
          through our platform. <br /> Join thousands of satisfied candidates
          across India.
        </motion.h4>
                ...
                return (
                  <motion.div
                    ...
                    style={{
                      ...
                      backgroundColor:
                        index === currentTestimonial ? "#3b82f6" : "#e5e7eb",
                    }}
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                >
                  ...
                  >
                    &quot;
                    {currentData.text.length > 100
                      ? currentData.text.substring(0, 100) + "..."
                      : currentData.text}
                    &quot;
                  </motion.p>

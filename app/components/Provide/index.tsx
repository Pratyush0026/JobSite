...
const Aboutdata: datatype[] = [
    {
        ...
        paragraph: 'Find cleaning and maintenance jobs across hotels, offices, and residential areas',
    },
    {
        imgSrc: "/assets/provide/graphic.svg",
        country: "Technician Jobs",
        paragraph: 'Technical positions in electrical, mechanical, and IT support roles',
    },
    {
        imgSrc: "/assets/provide/heaking.svg",
    ...
    },
    {
        ...
        paragraph: 'Professional driving opportunities with top transportation companies',
    },
]
                    ...
                    >
                        <div className="flex flex-col align-middle justify-center p-10">
                            ...
                            <motion.h4 
                                ...
                                transition={{ duration: 0.6, delay: 0.5 }}
                            >
                                Discover thousands of job opportunities across India's fastest-growing sectors. From entry-level positions to skilled roles, we connect you with trusted employers offering competitive salaries and growth opportunities in your preferred location.
                            </motion.h4>
